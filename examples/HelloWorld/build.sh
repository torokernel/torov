...
/usr/bin/ld -b elf64-x86-64 -m elf_x86_64 boot.o -L. -o HelloWorld.elf -T HelloWorld.ld.elf -e _start
/usr/bin/ld -s boot.o -Map $app.map -L. -o $app -T $app.ld -e _start
